...
exports.solrTokenSaleProgram = void 0;
const web3_js_1 = require("@solana/web3.js");
const anchor_1 = require("@project-serum/anchor");
const coder_1 = require("./coder");
const SOLR_TOKEN_SALE_PROGRAM_ID = web3_js_1.PublicKey.default;
function solrTokenSaleProgram(params) {
    var _a;
    return new anchor_1.Program(IDL, (_a = params === null || params === void 0 ? void 0 : params.programId) !== null && _a !== void 0 ? _a : SOLR_TOKEN_SALE_PROGRAM_ID, params === null || params === void 0 ? void 0 : params.provider, new coder_1.SolrTokenSaleCoder(IDL));
}
exports.solrTokenSaleProgram = solrTokenSaleProgram;
const IDL = {
    version: "1.0.0",
    name: "token-sale",
    instructions: [
