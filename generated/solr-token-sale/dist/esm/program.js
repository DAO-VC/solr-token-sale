...
import { SolrTokenSaleCoder } from "./coder";
const SOLR_TOKEN_SALE_PROGRAM_ID = PublicKey.default;
export function solrTokenSaleProgram(params) {
    var _a;
    return new Program(IDL, (_a = params === null || params === void 0 ? void 0 : params.programId) !== null && _a !== void 0 ? _a : SOLR_TOKEN_SALE_PROGRAM_ID, params === null || params === void 0 ? void 0 : params.provider, new SolrTokenSaleCoder(IDL));
}
const IDL = {
    version: "1.0.0",
    name: "token-sale",
