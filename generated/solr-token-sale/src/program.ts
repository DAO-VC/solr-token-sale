...
export function solrTokenSaleProgram(
  params?: GetProgramParams
): Program<SolrTokenSale> {
  return new Program<SolrTokenSale>(
    IDL,
    params?.programId ?? SOLR_TOKEN_SALE_PROGRAM_ID,
    params?.provider,
    new SolrTokenSaleCoder(IDL)
  );
}
